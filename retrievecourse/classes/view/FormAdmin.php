...
class FormAdmin extends moodleform {
	...
	private function creationListeCour($mform) {
		...
		$mform->getElement ( 'cours' )->setSelected ( array (
				'-1' 
		) );
	...
	/**
	 * Permet d'initilaiser la liste des cours.
	 */
	private function initialiserListeCour() {
		// Les informations ,qu'on récupére ici, ont été placé dans l'url dans la méthode envoiInfoTrie()
		// de la classe ControllerFormAdmin
